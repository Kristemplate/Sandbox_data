...
``` {r normcheck, echo = FALSE, warning = FALSE, message = FALSE, results = 'hide'}
...
``` {r pre_3_and_4, echo = FALSE, warning = FALSE, message = FALSE, results = 'hide'}
# ------------
# Option 3 & 4
# ------------
...
for (i in 1:length(Full_All_p_3SD_P.participants$meanBias)){
  if (Full_All_p_3SD_P.participants$meanBias[i] < hi_Full_All.p_3SD_P & Full_All_p_3SD_P.participants$meanBias[i] > lo_Full_All.p_3SD_P){
    ...
    # Dataset specification
Full_All_p_3SD_P = Full_All
Full_All_p_3SD_P$isgroupoutlier = rep(NA,length(Full_All_p_3SD_P$Participant))
Group_outliers = Full_All_p_3SD_P.participants$Participant[Full_All_p_3SD_P.participants$isoutlier == 1]

for (i in 1:length(Full_All_p_3SD_P$Participant)){
  if (!is.na(match(Full_All_p_3SD_P$Participant[i],Group_outliers)))
  {
    Full_All_p_3SD_P$isgroupoutlier[i] = 1
  } else {
    Full_All_p_3SD_P$isgroupoutlier[i] = 0
  }
}

Full_All_p_3SD_P = Full_All_p_3SD_P[Full_All_p_3SD_P$isgroupoutlier == 0,]


# Removal of outlier trials

m.Full_All_p_3SD_P = mean(Full_All_p_3SD_P$Bias)
Full_All_p_3SD_P.SDs = ddply(Full_All_p_3SD_P, c("Participant"), summarise, sdBias = sd(Bias),
                                                                  sdBias_squared = sdBias^2)
psd.Full_All_p_3SD_P = sqrt(sum(Full_All_p_3SD_P.SDs$sdBias_squared)/length(Full_All_p_3SD_P.SDs$Participant))


hi.Full_All_p_3SD_P = m.Full_All_p_3SD_P + 3 * psd.Full_All_p_3SD_P
lo.Full_All_p_3SD_P = m.Full_All_p_3SD_P - 3 * psd.Full_All_p_3SD_P

Full_All_p_3SD_PT = Full_All_p_3SD_P[Full_All_p_3SD_P$Bias < hi.Full_All_p_3SD_P,]
Full_All_p_3SD_PT = Full_All_p_3SD_PT[Full_All_p_3SD_PT$Bias > lo.Full_All_p_3SD_P,]
...
for (i in 1:length(Full_All_p_2SD_P.participants$meanBias)){
  if (Full_All_p_2SD_P.participants$meanBias[i] < hi_Full_All.p_2SD_P & Full_All_p_2SD_P.participants$meanBias[i] > lo_Full_All.p_2SD_P){
    ...
    # Dataset specification
Full_All_p_2SD_P = Full_All
Full_All_p_2SD_P$isgroupoutlier = rep(NA,length(Full_All_p_2SD_P$Participant))
Group_outliers = Full_All_p_2SD_P.participants$Participant[Full_All_p_2SD_P.participants$isoutlier == 1]

for (i in 1:length(Full_All_p_2SD_P$Participant)){
  if (!is.na(match(Full_All_p_2SD_P$Participant[i],Group_outliers)))
  {
    Full_All_p_2SD_P$isgroupoutlier[i] = 1
  } else {
    Full_All_p_2SD_P$isgroupoutlier[i] = 0
  }
}

Full_All_p_2SD_P = Full_All_p_2SD_P[Full_All_p_2SD_P$isgroupoutlier == 0,]


# Removal of outlier trials

m.Full_All_p_2SD_P = mean(Full_All_p_2SD_P$Bias)
Full_All_p_2SD_P.SDs = ddply(Full_All_p_2SD_P, c("Participant"), summarise, sdBias = sd(Bias),
                                                                  sdBias_squared = sdBias^2)
psd.Full_All_p_2SD_P = sqrt(sum(Full_All_p_2SD_P.SDs$sdBias_squared)/length(Full_All_p_2SD_P.SDs$Participant))


hi.Full_All_p_2SD_P = m.Full_All_p_2SD_P + 2 * psd.Full_All_p_2SD_P
lo.Full_All_p_2SD_P = m.Full_All_p_2SD_P - 2 * psd.Full_All_p_2SD_P

Full_All_p_2SD_PT = Full_All_p_2SD_P[Full_All_p_2SD_P$Bias < hi.Full_All_p_2SD_P,]
Full_All_p_2SD_PT = Full_All_p_2SD_PT[Full_All_p_2SD_PT$Bias > lo.Full_All_p_2SD_P,]
...
Full_Sep_p_3SD_TP = rbind(Full_FB_p_3SD_TP,Full_MC_p_3SD_TP)
...
Full_Sep_p_2SD_TP = rbind(Full_FB_p_2SD_TP,Full_MC_p_2SD_TP)
...
hi.Full_FB_p_3SD_P = m.Full_FB_p_3SD_P + 3 * psd.Full_FB_p_3SD_P
lo.Full_FB_p_3SD_P = m.Full_FB_p_3SD_P - 3 * psd.Full_FB_p_3SD_P

Full_FB_p_3SD_PT = Full_FB_p_3SD_P[Full_FB_p_3SD_P$Bias < hi.Full_FB_p_3SD_P,]
Full_FB_p_3SD_PT = Full_FB_p_3SD_PT[Full_FB_p_3SD_PT$Bias > lo.Full_FB_p_3SD_P,]
...
hi.Full_MC_p_3SD_P = m.Full_MC_p_3SD_P + 3 * psd.Full_MC_p_3SD_P
lo.Full_MC_p_3SD_P = m.Full_MC_p_3SD_P - 3 * psd.Full_MC_p_3SD_P

Full_MC_p_3SD_PT = Full_MC_p_3SD_P[Full_MC_p_3SD_P$Bias < hi.Full_MC_p_3SD_P,]
Full_MC_p_3SD_PT = Full_MC_p_3SD_PT[Full_MC_p_3SD_TP$Bias > lo.Full_MC_p_3SD_P,]


# Combine

Full_Sep_p_3SD_PT = rbind(Full_FB_p_3SD_TP,Full_MC_p_3SD_TP)
...
hi.Full_FB_p_2SD_P = m.Full_FB_p_2SD_P + 2 * psd.Full_FB_p_2SD_P
lo.Full_FB_p_2SD_P = m.Full_FB_p_2SD_P - 2 * psd.Full_FB_p_2SD_P

Full_FB_p_2SD_PT = Full_FB_p_2SD_P[Full_FB_p_2SD_P$Bias < hi.Full_FB_p_2SD_P,]
Full_FB_p_2SD_PT = Full_FB_p_2SD_PT[Full_FB_p_2SD_PT$Bias > lo.Full_FB_p_2SD_P,]
...
Full_MC_p_2SD_PT = Full_MC_p_2SD_P[Full_MC_p_2SD_P$Bias < hi.Full_MC_p_2SD_P.2SD,]
Full_MC_p_2SD_PT = Full_MC_p_2SD_PT[Full_MC_p_2SD_PT$Bias > lo.Full_MC_p_2SD_P.2SD,]

# Combine

Full_Sep_p_2SD_PT = rbind(Full_FB_p_2SD_PT,Full_MC_p_2SD_PT)
...
Pass_All_s_2SD.participants = ddply(Pass_All, c("Participant"), summarise, meanBias = mean(Bias))

Pass_All_s_2SD.participants$isoutlier = rep(NA,length(Pass_All_s_2SD.participants$Participant))

m.Pass_All_s_2SD.participants = mean(Pass_All_s_2SD.participants$meanBias)
sd.Pass_All_s_2SD.participants = sd(Pass_All_s_2SD.participants$meanBias)

hi.Pass_All_s_2SD.participants = m.Pass_All_s_2SD.participants + 2 * sd.Pass_All_s_2SD.participants
lo.Pass_All_s_2SD.participants = m.Pass_All_s_2SD.participants - 2 * sd.Pass_All_s_2SD.participants

for (i in 1:length(Pass_All_s_2SD.participants$meanBias)){
  if (Pass_All_s_2SD.participants$meanBias[i] < hi.Pass_All_s_2SD.participants & Pass_All_s_2SD.participants$meanBias[i] > lo.Pass_All_s_2SD.participants){
    Pass_All_s_2SD.participants$isoutlier[i] = 0
  } else {
    Pass_All_s_2SD.participants$isoutlier[i] = 1
  }
}

    # Dataset specification
Pass_All_s_2SD_P = Pass_All

Pass_All_s_2SD_P$isgroupoutlier = rep(NA,length(Pass_All_s_2SD_P$Participant))
Group_outliers = Pass_All_s_2SD.participants$Participant[Pass_All_s_2SD.participants$isoutlier == 1]

for (i in 1:length(Pass_All_s_2SD_P$Participant)){
  if (!is.na(match(Pass_All_s_2SD_P$Participant[i],Group_outliers)))
  {
    Pass_All_s_2SD_P$isgroupoutlier[i] = 1
  } else {
    Pass_All_s_2SD_P$isgroupoutlier[i] = 0
  }
}

Pass_All_s_2SD_P = Pass_All_s_2SD_P[Pass_All_s_2SD_P$isgroupoutlier == 0,]

  # Note: Participant mean bias is not normally distributed, so s_2SD approach is preferable.
ad.test(Pass_All_s_2SD.participants$meanBias)

# Removal of outlier trials

m.Pass_All_s_2SD_P = mean(Pass_All_s_2SD_P$Bias)
sd.Pass_All_s_2SD_P = sd(Pass_All_s_2SD_P$Bias)

hi.Pass_All.s_2SD_P = m.Pass_All_s_2SD_P + 2 * sd.Pass_All_s_2SD_P
lo.Pass_All.s_2SD_P = m.Pass_All_s_2SD_P - 2 * sd.Pass_All_s_2SD_P

Pass_All_s_2SD_PT = Pass_All_s_2SD_P[Pass_All_s_2SD_P$Bias < hi.Pass_All.s_2SD_P,]
Pass_All_s_2SD_PT = Pass_All_s_2SD_PT[Pass_All_s_2SD_PT$Bias > lo.Pass_All.s_2SD_P,]
...
for (i in 1:length(Pass_All_p_3SD_P.participants$meanBias)){
  if (Pass_All_p_3SD_P.participants$meanBias[i] < hi_Pass_All.p_3SD_P & Pass_All_p_3SD_P.participants$meanBias[i] > lo_Pass_All.p_3SD_P){
    ...
    # Dataset specification
Pass_All_p_3SD_P = Pass_All
Pass_All_p_3SD_P$isgroupoutlier = rep(NA,length(Pass_All_p_3SD_P$Participant))
Group_outliers = Pass_All_p_3SD_P.participants$Participant[Pass_All_p_3SD_P.participants$isoutlier == 1]

for (i in 1:length(Pass_All_p_3SD_P$Participant)){
  if (!is.na(match(Pass_All_p_3SD_P$Participant[i],Group_outliers)))
  {
    Pass_All_p_3SD_P$isgroupoutlier[i] = 1
  } else {
    Pass_All_p_3SD_P$isgroupoutlier[i] = 0
  }
}

Pass_All_p_3SD_ = Pass_All_p_3SD_P[Pass_All_p_3SD_P$isgroupoutlier == 0,]


# Removal of outlier trials

m.Pass_All_p_3SD_P = mean(Pass_All_p_3SD_P$Bias)
Pass_All_p_3SD_P.SDs = ddply(Pass_All_p_3SD_P, c("Participant"), summarise, sdBias = sd(Bias),
                                                                  sdBias_squared = sdBias^2)
psd.Pass_All_p_3SD_P = sqrt(sum(Pass_All_p_3SD_P.SDs$sdBias_squared)/length(Pass_All_p_3SD_P.SDs$Participant))

hi.Pass_All_p_3SD_P = m.Pass_All_p_3SD_P + 3 * psd.Pass_All_p_3SD_P
lo.Pass_All_p_3SD_P = m.Pass_All_p_3SD_P - 3 * psd.Pass_All_p_3SD_P

Pass_All_p_3SD_PT = Pass_All_p_3SD_P[Pass_All_p_3SD_P$Bias < hi.Pass_All_p_3SD_P,]
Pass_All_p_3SD_PT = Pass_All_p_3SD_PT[Pass_All_p_3SD_PT$Bias > lo.Pass_All_p_3SD_P,]
...
for (i in 1:length(Pass_All_p_2SD_P.participants$meanBias)){
  if (Pass_All_p_2SD_P.participants$meanBias[i] < hi_Pass_All.p_2SD_P & Pass_All_p_2SD_P.participants$meanBias[i] > lo_Pass_All.p_2SD_P){
    ...
    # Dataset specification
Pass_All_p_2SD_P = Pass_All
Pass_All_p_2SD_P$isgroupoutlier = rep(NA,length(Pass_All_p_2SD_P$Participant))
Group_outliers = Pass_All_p_2SD_P.participants$Participant[Pass_All_p_2SD_P.participants$isoutlier == 1]

for (i in 1:length(Pass_All_p_2SD_P$Participant)){
  if (!is.na(match(Pass_All_p_2SD_P$Participant[i],Group_outliers)))
  {
    Pass_All_p_2SD_P$isgroupoutlier[i] = 1
  } else {
    Pass_All_p_2SD_P$isgroupoutlier[i] = 0
  }
}

Pass_All_p_2SD_ = Pass_All_p_2SD_P[Pass_All_p_2SD_P$isgroupoutlier == 0,]


# Removal of outlier trials

m.Pass_All_p_2SD_P = mean(Pass_All_p_2SD_P$Bias)
Pass_All_p_2SD_P.SDs = ddply(Pass_All_p_2SD_P, c("Participant"), summarise, sdBias = sd(Bias),
                                                                  sdBias_squared = sdBias^2)
psd.Pass_All_p_2SD_P = sqrt(sum(Pass_All_p_2SD_P.SDs$sdBias_squared)/length(Pass_All_p_2SD_P.SDs$Participant))

hi.Pass_All_p_2SD_P = m.Pass_All_p_2SD_P + 2 * psd.Pass_All_p_2SD_P
lo.Pass_All_p_2SD_P = m.Pass_All_p_2SD_P - 2 * psd.Pass_All_p_2SD_P

Pass_All_p_2SD_PT = Pass_All_p_2SD_P[Pass_All_p_2SD_P$Bias < hi.Pass_All_p_2SD_P,]
Pass_All_p_2SD_PT = Pass_All_p_2SD_PT[Pass_All_p_2SD_PT$Bias > lo.Pass_All_p_2SD_P,]
...
Pass_Sep_p_3SD_TP = rbind(Pass_FB_p_3SD_TP,Pass_MC_p_3SD_TP)
...
Pass_Sep_p_2SD_TP = rbind(Pass_FB_p_2SD_TP,Pass_MC_p_2SD_TP)
...
Pass_FB_p_3SD_PT = Pass_FB_p_3SD_P[Pass_FB_p_3SD_P$Bias < hi.Pass_FB_p_3SD_P.3SD,]
Pass_FB_p_3SD_PT = Pass_FB_p_3SD_PT[Pass_FB_p_3SD_PT$Bias > lo.Pass_FB_p_3SD_P.3SD,]
...
Pass_MC_p_3SD_PT = Pass_MC_p_3SD_P[Pass_MC_p_3SD_P$Bias < hi.Pass_MC_p_3SD_P.3SD,]
Pass_MC_p_3SD_PT = Pass_MC_p_3SD_PT[Pass_MC_p_3SD_PT$Bias > lo.Pass_MC_p_3SD_P.3SD,]


# Combine

Pass_Sep_p_3SD_PT = rbind(Pass_FB_p_3SD_PT,Pass_MC_p_3SD_PT)
...
Pass_FB_p_2SD_PT = Pass_FB_p_2SD_P[Pass_FB_p_2SD_P$Bias < hi.Pass_FB_p_2SD_P.2SD,]
Pass_FB_p_2SD_PT = Pass_FB_p_2SD_PT[Pass_FB_p_2SD_PT$Bias > lo.Pass_FB_p_2SD_P.2SD,]
...
Pass_MC_p_2SD_PT = Pass_MC_p_2SD_P[Pass_MC_p_2SD_P$Bias < hi.Pass_MC_p_2SD_P.2SD,]
Pass_MC_p_2SD_PT = Pass_MC_p_2SD_PT[Pass_MC_p_2SD_PT$Bias > lo.Pass_MC_p_2SD_P.2SD,]


# Combine

Pass_Sep_p_2SD_PT = rbind(Pass_FB_p_2SD_PT,Pass_MC_p_2SD_PT)
...
Choice_string = paste(c(opt1,"_",opt2,"_",opt3,"_",opt4,"_",opt5),collapse = "")

Choice = get(Choice_string)

Participant_IDs = unique(Choice$Participant)

paste(c("This data set includes ",length(Participant_IDs)," participants, with ", length(Choice$Participant), " trials", collapse = ""))
...
Trials_table = ddply(Choice, "Participant", summarise, nTrials = length(Bias))
Trials_table = Trials_table[Trials_table$nTrials < 16,]
Trials_table$nTrials = 16 - Trials_table$nTrials
names(Trials_table) = c("Participant with outliers","Outliers removed")
Trials_table
...
paste(c("There are ", length(Trials_table$Participant), " participants with outliers"), collapse = "")
...
Note: Add option to choose order of Condition, Reward and AQ for plots (X, Y and Z)
